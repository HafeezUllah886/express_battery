                                    ...
                                    <table class="table table-borderless text-center table-nowrap align-middle mb-0">
                                        ...
                                        @foreach ($products as $key => $product)
                                            <tr>
                                                ...
                                                <td class="text-end">{{  number_format($product->avg_price) }}</td>
                                                <td class="text-end">{{ number_format($product->sold) }}</td>
                                        ...
                                        <tfoot>
                                            <tr>
                                                ...
                                                <th class="text-end">{{number_format($products->sum('sold'), 2)}}</th>
