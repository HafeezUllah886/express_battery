                        ...
                        <div class="col">
                            <div class="mt-3 mt-lg-0 py-4 px-3">
                                ...
                                <div class="d-flex align-items-center">
                                    ...
                                    <div class="flex-grow-1 ms-3">
                                        <h2 class="mb-0 cfs-22 {{ $vendorsBalance < 0 ? 'text-danger' : 'text-success' }}"">
                        ...
                        <div class="col">
                            <div class="mt-3 mt-lg-0 py-4 px-3">
                                ...
                                <div class="d-flex align-items-center">
                                    ...
                                    <div class="flex-grow-1 ms-3">
                                        <h2 class="mb-0 cfs-22 {{ $myBalance < 0 ? 'text-danger' : 'text-success' }}""><span
                                                class="counter-value" data-target="{{ myBalance() }}">0</span></h2>
                                    </div>
                                </div>
                            </div>
                        </div><!-- end col -->
                ...
                var e = {
                    series: [{
                        ...
                        }, // Updated Orders data
                        {
                            ...
                            type: "bar",
                            data: earningsData
                        }, // Updated Earnings data
                        {
                            name: "Expense",
                            type: "line",
                            data: refundsData
                        } // Updated Refunds data
                    ],
                    chart: {
                        height: 370,
                        type: "line",
