                ...
                <div class="row">
                    <div class="col-lg-12">
                        <div class="hstack gap-2 justify-content-end d-print-none p-2 mt-4">
                            {{--  <a href="{{ url('quotation/pdf/') }}/{{ $quot->id }}" class="btn btn-info ml-4"><i
                                    class="ri-file-line mr-4"></i> Generate PDF</a>
                                ...
                                <table class="table table-borderless text-center table-nowrap align-middle mb-0">
                                    ...
                                    <tfoot>
                                        <tr class="border-1 border-dark">
                                            ...
                                            <th class="text-end p-1">{{ number_format($quot->details->sum('amount'), 2) }}
                                            </th>
                                        </tr>
