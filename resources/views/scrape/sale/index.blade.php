            ...
            <div class="card">
                ...
                @endif
                    ...
                    <table class="table" id="buttons-datatables">
                        ...
                        <tbody>
                            @foreach ($scrapeSales as $key => $sale)
                                <tr>
                                    <td>{{ $key + 1 }}</td>
                                    ...
                                    <td>{{ $sale->notes }}</td>
                                    <td>
                                        <a href="{{ route('scrap_sale.delete', $sale->refID) }}"
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="myModalLabel">Create Scrap Sale</h5>
                    <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"> </button>
                </div>
                <form action="{{ route('scrap_sale.store') }}" method="post">
                    @csrf
                    <div class="modal-body">
                        <div class="form-group mt-2">
                            ...
                            <div class="input-group">
                                ...
                                <input type="number" step="any" oninput="updateAmount()" max="{{$stock}}"  required name="weight" id="weight"
                                    class="form-control">
