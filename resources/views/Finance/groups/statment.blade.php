                            ...
                            <div class="card-body p-4">
                                <div class="row g-3">
                                    <div class="col-lg-3 col-6">
                                        <p class="text-muted mb-2 text-uppercase fw-semibold">Group Name</p>
                                        <h5 class="fs-14 mb-0">{{ $group->group_name }}</h5>
                                        <h5 class="fs-14 mb-0"><small class="text-muted" id="invoice-time">Account One </small>{{ $group->account1->title }}</h5>
                                        <h5 class="fs-14 mb-0"><small class="text-muted" id="invoice-time">Account Two </small>{{ $group->account2->title }}</h5>
                                    </div>
                                    <!--end col-->
                                    <div class="col-lg-3 col-6">
                                    ...
                                    <table class="table table-borderless text-center table-nowrap align-middle mb-0">
                                        ...
                                        @endphp
                                            <tr>
                                                ...
                                                <td class="text-start" style="max-width: 200px">{!! $trans->notes !!} <br> 
                                                    @php
                                        ...
                                        <tfoot>
                                            <tr>
                                                ...
                                                <td class="text-end text-success">{{ number_format($transactions->sum('cr')) }}</td>
                                                <td class="text-end text-danger">{{ number_format($transactions->sum('db')) }}</td>
                                                <td class="text-end">{{ number_format($balance) }}</td>
                                            </tr>
                                        </tfoot>
                                    </table><!--end table-->
